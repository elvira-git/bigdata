...
token<- "EAACEdEose0cBAM1I10xPK9fdmfUF4LXilBSYhDZA7B8XRYi1ZBHN7iH5ZAV98kDSFmqH4k6IrgwmoB5WG6k2m7ATZApn2CpHKnK6Y4PNTbjAcqh8jhRIPIJqKSg6AZAZAZCvbsXJMaPB8l2oAPZABWxzwDTyPzZArIfvwFzegiBKuZA7QEtVVPLqDwmQzZAjT1q8ZAoZD"
me<- getUsers("10204424657285652", token, private_info = TRUE) #ID from Graph API Explorer
...
# Based on 100 posts, most popular are:
# Prince George http://bbc.in/2vJl2XO
# Peggy, 86 https://www.facebook.com/bbcnews/videos/1479177572139344/
# Chester Bennington’s music http://www.bbc.com/news/world-us-canada-40677254

#Sort by most liked posts
ny_sort_by_likes = nytpage[order(nytpage$likes_count, decreasing = TRUE),] 

# Resignation of White House Press Secretary https://goo.gl/MLw6VN
# HealthCare in the US https://goo.gl/XRRKVt
# Kentucky Must Pay $224,000 After Dispute Over Same-Sex Marriage Licenses https://goo.gl/ePUxPH
...
#Barplots
#bar_counts <- table(bbc$day, bbc$likes_count)
#barplot(bar_counts)
